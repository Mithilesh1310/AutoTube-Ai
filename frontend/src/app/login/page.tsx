...
import { loginUser, googleLoginUser, setAuthToken, setStoredUser } from '@/lib/api';
import { Play, Sparkles, Lock, Mail, ArrowRight, CheckCircle2, ShieldCheck, AlertCircle } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafc] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[350px] bg-gradient-to-b from-indigo-100/60 via-purple-50/40 to-transparent blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 right-0 w-96 h-96 bg-amber-100/40 blur-3xl rounded-full pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="mt-2 text-center text-sm text-neutral-500">
          Sign in to scale your autonomous YouTube channels
        </p>
      </div>
